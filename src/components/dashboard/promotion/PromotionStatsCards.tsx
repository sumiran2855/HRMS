import { TrendingUp, Clock3, CheckCircle2, XCircle } from "lucide-react"
import { PromotionStats } from "@/types/promotion.types"

interface PromotionStatsCardsProps {
  stats: PromotionStats
}

export function PromotionStatsCards({ stats }: PromotionStatsCardsProps) {
  return (
