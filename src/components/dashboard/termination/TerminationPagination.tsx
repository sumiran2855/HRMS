import { TERMINATION_PAGE_SIZE_OPTIONS } from "@/constants/termination"
...
export function TerminationPagination({
  totalPages,
  currentPage,
  rowsPerPage,
  setRowsPerPage,
  ...
  return (
    <div className="bg-white rounded-xl border border-slate-200 p-4 flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
      <p className="text-sm text-slate-600">Showing {filteredCount} termination requests</p>
      ...
      <div className="flex items-center gap-2">
        ...
        >
          {TERMINATION_PAGE_SIZE_OPTIONS.map((size) => (
