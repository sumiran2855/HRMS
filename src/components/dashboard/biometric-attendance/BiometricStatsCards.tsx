import { BiometricStats } from "@/types/attendance.types";
import { BIOMETRIC_STAT_CARDS } from "@/constants/attendance";

interface BiometricStatsCardsProps {
  stats: BiometricStats;
}

export function BiometricStatsCards({ stats }: BiometricStatsCardsProps) {
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4">
      {BIOMETRIC_STAT_CARDS.map(
