...
import { X, Truck, Trash2, AlertTriangle } from "lucide-react"
...
export default function DeleteOrderModal({ isOpen, onClose, order, onConfirm, formatCurrency }: DeleteOrderModalProps) {
      ...
      <div className="animate-in fade-in zoom-in-95 duration-200 bg-white rounded-2xl w-full max-w-[480px] shadow-2xl">
        <div className="sticky top-0 z-10 bg-white border-b border-slate-200 px-6 py-4 flex items-center justify-between rounded-t-2xl">
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="text-[15px] font-bold text-slate-900">Delete Purchase Order</div>
        ...
        <div className="p-6 space-y-5">
          <div className="flex items-start gap-4 p-4 bg-red-50 border border-red-200 rounded-xl">
            ...
            <div>
              ...
              <p className="text-sm text-red-600">You are about to permanently delete this purchase order and all associated data.</p>
            </div>
          </div>
          ...
          <div className="bg-slate-50 rounded-xl p-4 border border-slate-200 space-y-2">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="text-slate-900">{order.vendor}</span>
            </div>
            <div className="flex justify-between text-sm">
            ...
            <div className="flex justify-between text-sm">
              ...
              <span className="text-slate-900 capitalize">{order.status}</span>
            </div>
          </div>
