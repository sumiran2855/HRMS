...
export default function ViewOrderModal({
  ...
  return (
    ...
    >
      <div className="animate-in fade-in zoom-in-95 duration-200 bg-white rounded-2xl w-full max-w-[620px] max-h-[90vh] overflow-y-auto shadow-2xl [&::-webkit-scrollbar]:hidden">
        {/* Header */}
