...
import { ShieldCheck, Users, PlayCircle, ArrowRight } from 'lucide-react';
      ...
      <div className="container mx-auto px-6 lg:px-8 relative z-10">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-20">
            <Button size="lg" variant="primary" className="shadow-2xl shadow-blue-500/25 group">
              <span>Start Free Trial</span>
              <ArrowRight className="w-5 h-5 ml-2 group-hover:translate-x-1 transition-transform" />
            </Button>
            <Button size="lg" variant="secondary" className="border-2 border-white/30 backdrop-blur-sm">
